...
<nav id="navbar">
    ...
    <div class="nav-right" id="navRight">
        ...
        <div class="nav-icons">
            ...
            <!-- Cart -->
            <a href="login.php" class="cart-icon-wrapper" id="cartIcon" style="text-decoration: none; color: inherit;">
        ...
        <div class="nav-auth-profile">
            ...
            <?php else: ?>
                ...
                <a href="login.php" class="nav-auth-link" id="loginBtn" style="display: block;">
